...
/*
 * Returns the self of this frame.
 */
static VALUE
location_self_m(VALUE self)
{
    return location_ptr(self)->self;
}
...
{
    return location_ptr(self)->klass;
}
...
Init_vm_backtrace(void)
{
    ...
    rb_define_method(rb_cBacktraceLocation, "self", location_self_m, 0);
