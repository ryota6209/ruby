...
class TestInteger < Test::Unit::TestCase
  ...
  def test_round
    ...
    assert_int_equal(-200, -249.round(-2))
    assert_int_equal(+200, +249.round(-2, to: :even))
    assert_int_equal(+200, +250.round(-2, to: :even))
    assert_int_equal(+300, +349.round(-2, to: :even))
    assert_int_equal(+400, +350.round(-2, to: :even))
    assert_int_equal(+200, +249.round(-2, to: :nearest))
    assert_int_equal(+300, +250.round(-2, to: :nearest))
    assert_int_equal(+300, +349.round(-2, to: :nearest))
    assert_int_equal(+400, +350.round(-2, to: :nearest))
    assert_int_equal(-300, -250.round(-2))
    assert_int_equal(-200, -249.round(-2, to: :even))
    assert_int_equal(-200, -250.round(-2, to: :even))
    assert_int_equal(-300, -349.round(-2, to: :even))
    ...
    assert_int_equal(-30 * 10**70, (-35 * 10**70 + 1).round(-71))
    assert_int_equal(+20 * 10**70, (+25 * 10**70).round(-71, to: :even))
    assert_int_equal(-20 * 10**70, (-25 * 10**70).round(-71, to: :even))
    assert_int_equal(+20 * 10**70, (+25 * 10**70 - 1).round(-71, to: :even))
    assert_int_equal(-20 * 10**70, (-25 * 10**70 + 1).round(-71, to: :even))
    assert_int_equal(+40 * 10**70, (+35 * 10**70).round(-71, to: :even))
    assert_int_equal(-40 * 10**70, (-35 * 10**70).round(-71, to: :even))
    assert_int_equal(+30 * 10**70, (+35 * 10**70 - 1).round(-71, to: :even))
    assert_int_equal(-30 * 10**70, (-35 * 10**70 + 1).round(-71, to: :even))
    assert_int_equal(+30 * 10**70, (+25 * 10**70).round(-71, to: :nearest))
    assert_int_equal(-30 * 10**70, (-25 * 10**70).round(-71, to: :nearest))
    assert_int_equal(+20 * 10**70, (+25 * 10**70 - 1).round(-71, to: :nearest))
    assert_int_equal(-20 * 10**70, (-25 * 10**70 + 1).round(-71, to: :nearest))
    assert_int_equal(+40 * 10**70, (+35 * 10**70).round(-71, to: :nearest))
    assert_int_equal(-40 * 10**70, (-35 * 10**70).round(-71, to: :nearest))
    assert_int_equal(+30 * 10**70, (+35 * 10**70 - 1).round(-71, to: :nearest))
    assert_int_equal(-30 * 10**70, (-35 * 10**70 + 1).round(-71, to: :nearest))
